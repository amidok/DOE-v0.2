...
public:
	...
	void edit_fullName(list<Abiturient>::iterator it, string surname, string name, string patronymic);
	void edit_points(list<Abiturient>::iterator it, double sum, double certificate, double exam);

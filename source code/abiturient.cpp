...
void Abiturient::setPatronymic(string patronymic)
{
	this->patronymic = patronymic;
}
void Abiturient::setCertificate(double certificate)
{
	this->certificate = certificate;
}
void Abiturient::setExam(double exam)
{
	this->exam = exam;
}
void Abiturient::setSum(double sum)
{
	this->sum = sum;
}
